                        ...
                        if (NOS_API.display_custom_dialog("O Led Power est\xe1 Vermelho?", 2, ["OK", "NOK"], NOS_API.WAIT_TIME_TO_CLOSE_DIALOG) == "OK"):
                            ...
                            if (NOS_API.display_custom_dialog("O Led Power est\xe1 Verde?", 2, ["OK", "NOK"], NOS_API.WAIT_TIME_TO_CLOSE_DIALOG) == "OK"):
                                ...
                                if (NOS_API.wait_for_multiple_pictures(["AutoDiag_End_ref"], 60, ["[AutoDiag_End]"], [TEST_CREATION_API.DEFAULT_HDMI_VIDEO_THRESHOLD]) != -1):
                                    ...
                                    video_result = NOS_API.compare_pictures("AutoDiag_End_ref", "AutoDiag_Result", "[AutoDiag_Pass]")
                                    if (video_result > TEST_CREATION_API.DEFAULT_HDMI_VIDEO_THRESHOLD):
                                        test_result = "PASS"
                                        counter = 2
                                        ...
                                        data_array = NOS_API.get_pixels_average_values("AutoDiag_Result", 295, 86, 314, 102)
                                        ...
                                        if (data_array[1] - data_array[0] < 45):
                                            ...
                                            NOS_API.deinitialize()
                                            return                            
                                        data_array = NOS_API.get_pixels_average_values("AutoDiag_Result", 225, 115, 245, 130)
                                        TEST_CREATION_API.write_log_to_file(data_array[1] - data_array[0])
                                        if (data_array[1] - data_array[0] < 45):
                                            ...
                                            NOS_API.deinitialize()
                                            return                           
                                        data_array = NOS_API.get_pixels_average_values("AutoDiag_Result", 236, 144, 255, 157)
                                        TEST_CREATION_API.write_log_to_file(data_array[1] - data_array[0])
                                        if (data_array[1] - data_array[0] < 45):
                                            ...
                                            NOS_API.deinitialize()
                                            return
                                        data_array = NOS_API.get_pixels_average_values("AutoDiag_Result", 278, 172, 295, 184)
                                        TEST_CREATION_API.write_log_to_file(data_array[1] - data_array[0])
                                        if (data_array[1] - data_array[0] < 45):
                                            ...
                                            NOS_API.deinitialize()
                                            return
                                        data_array = NOS_API.get_pixels_average_values("AutoDiag_Result", 334, 201, 349, 213)
                                        TEST_CREATION_API.write_log_to_file(data_array[1] - data_array[0])
                                        if (data_array[1] - data_array[0] < 45):
